...
void CircularAlgorithm::swap(std::vector<double> &vec, int i, int j) {
...
void CircularAlgorithm::bubbleSort(std::vector<double> &v1, std::vector<double> &v2, std::vector<double> &v3){
...
void CircularAlgorithm::estimate(void){
    double c = 0.5;
    double p = 0.5;
    double tol = 0.000001;
    int nBest = 3;

    xi = {0.36,1.57,11.26, 7.12};
    yi = {5.6,3.31,1.03,4.09};
    d  = {8,7,9,4};
    ...
    std::cout << yi[0] << " " << yi[1] << " " << yi[2] << std::endl;
    grad.push_back(0);
    grad.push_back(0);
